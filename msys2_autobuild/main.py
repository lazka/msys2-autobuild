...
from . import (cmd_build, cmd_clean_assets, cmd_clear_failed, cmd_exec_build_plan,
               cmd_fetch_assets, cmd_show_build, cmd_show_status, cmd_sign_package,
               cmd_supervise, cmd_update_status, cmd_upload_assets, cmd_write_build_plan)
...
def main(argv: list[str]) -> None:
    ...
    cmd_sign_package.add_parser(subparsers)
