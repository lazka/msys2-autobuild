...
usage: msys2-autobuild [-h] [-v]
    {build,show,write-build-plan,update-status,show-status,fetch-assets,upload-assets,clear-failed,clean-assets,supervise,exec-build-plan,sign-package} ...
...
subcommands:
  {build,show,write-build-plan,update-status,show-status,fetch-assets,upload-assets,clear-failed,clean-assets,supervise,exec-build-plan,sign-package}
    ...
    sign-package        Sign binaries inside .pkg.tar.zst archives
```
